  ...
  DATA = {
    :it => {
        ...
        :canaro_invita_maietti => {
          :description => 
            "Al \"Teatro Astral\" di Buenos Aires, il Maestro Francisco Canaro 
            invita il Maestro Aldo Maietti a dirigere la sua orchestra 
            accompagnando il cantnte Ernesto Rondò nel tango \"Mano a Mano\" di 
            Carlos Gardel (il più grando cantante argentino di tanghi negli anni 
            30). Commemorazione in onore al XXV anniversario della scomparsa di 
            Carlos Gardel.
            Sullo sfondo la foto di Carlos Gardel, perito in un incidente aereo 
            il 24 Giugno del 1935 Medellin.",
          :date => "24 e 25 Giugno 1961",
          :place => "Buenos Aires",
          :position => 13
        },
